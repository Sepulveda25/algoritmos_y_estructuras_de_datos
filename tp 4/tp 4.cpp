...
int main(int argc, char *argv[])
{
    ...
    t = clock(); // empieza conteo de tiepo (heap)
    ...
    t = clock() - t;//fin del conteo de tiepo (heap)
    
    /*
    for (int i=1;i<=(MAX-1);i++)// imprime heap ordenado
    {
        cout<<*(v+i)<<endl;
    }
    */
    
    cout<<"Tiempo de ejecucion de ordenamiento con Heap sort: "<<float (t)/(CLOCKS_PER_SEC)<<" segundos"<<endl;
  //-----------------------------------------------Ordenamiento por insercion comeinzo
    ...
    t = clock(); // empieza conteo de tiepo (insercion)
    for(i=1;i<MAX;i++)
    {
        j=i-1; di=a[i];           
        while(di<a[j] && j>=0)
     ...
     t = clock() - t;//fin del conteo de tiepo (insercion)
     
     /*
    for (int i=1;i<=(MAX-1);i++)// imprime insercion ordenada
    {
        cout<<*(a+i)<<endl;
    }
    */
     
     cout<<"\n\nTiempo de ejecucion de ordenamiento con insercion: "<<float (t)/(CLOCKS_PER_SEC)<<" segundos\n\n"<<endl;
    system("PAUSE");
    return EXIT_SUCCESS;
}
